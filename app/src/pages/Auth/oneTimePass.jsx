...
import { Gem, Crown, Diamond, Mail, ArrowLeft, CheckCircle, RefreshCw } from 'lucide-react';
...
const JewelryOTPPage = () => {
    ...
    const [userEmail, setUserEmail] = useState('user@example.com'); // This would come from props or context
    ...
    return (
        <div className="relative">
            ...
            >
                ...
                <span className="text-gray-600 group-hover:text-gray-800 font-medium">Back</span>
            </button>
                        ...
                        <div className="relative">
                            ...
                            <div className="bg-white rounded-full p-12 shadow-2xl border-4 border-gradient-to-r from-yellow-300 to-pink-300">
                                <svg width="200" height="200" viewBox="0 0 200 200" className="mx-auto">
                                    {/* Shield/Lock shape */}
                                    <path d="M100 20 L160 50 L160 120 Q160 160 100 180 Q40 160 40 120 L40 50 Z" fill="#9d4edd" opacity="0.9" />
                                    <path d="M100 30 L150 55 L150 115 Q150 150 100 170 Q50 150 50 115 L50 55 Z" fill="#d4af37" opacity="0.8" />
                                    
                                    {/* Lock symbol */}
                                    <circle cx="100" cy="90" r="25" fill="none" stroke="#ffffff" strokeWidth="6" />
                                    <rect x="85" y="105" width="30" height="40" fill="#ffffff" rx="5" />
                                    <circle cx="100" cy="115" r="6" fill="#9d4edd" />
                                    <rect x="98" y="118" width="4" height="15" fill="#9d4edd" />
                                    
                                    {/* Sparkles around */}
                                    <text x="60" y="40" fontSize="16" fill="#ffd700">✨</text>
                                    <text x="140" y="60" fontSize="14" fill="#ff6b9d">✨</text>
                                    <text x="70" y="160" fontSize="18" fill="#06ffa5">✨</text>
                                    <text x="130" y="170" fontSize="16" fill="#8338ec">✨</text>
                                </svg>
                            </div>
                        </div>
