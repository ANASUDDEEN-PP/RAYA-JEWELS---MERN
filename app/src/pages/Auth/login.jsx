  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (authData.status == 201) {
        ...
        authData.status == 202 &&
        authData.data.message == "Login Success"
      ) {
            ...
            <div className="relative">
              ...
              <div className="bg-white rounded-full p-12 shadow-2xl border-4 border-gradient-to-r from-yellow-300 to-pink-300">
                ...
                >
                  ...
                  {/* Sparkles */}
                  <text x="40" y="30" fontSize="20" fill="#ffd700">
                    ✨
                  </text>
                  <text x="160" y="40" fontSize="16" fill="#ff6b9d">
                    ✨
                  </text>
                  <text x="30" y="120" fontSize="18" fill="#9d4edd">
                    ✨
                  </text>
                  <text x="170" y="130" fontSize="14" fill="#06ffa5">
                    ✨
                  </text>
                </svg>
              </div>
          ...
          <div className="max-w-md w-full">
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                {isLogin && (
                    <Link to="/auth-forget-password" className="text-blue-700 font-medium">Forget Password</Link>
                )}
              </div>
